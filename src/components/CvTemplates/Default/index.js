...
function Default(props) {
  const { cvData } = props;
  const basicDetails = cvData.basicDetails
    ? cvData.basicDetails[0]
      ? cvData.basicDetails[0]
      : undefined
    : undefined;
  const employmentDetails = cvData.employmentDetails
    ? cvData.employmentDetails
    : undefined;
  ...
  const socialProfile = cvData.socialprofiles
    ? cvData.socialprofiles
    : undefined;
